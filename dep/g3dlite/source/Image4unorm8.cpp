...
Image4unorm8::Ref Image4unorm8::fromFile(const std::string& filename, WrapMode wrap) {
...
void Image4unorm8::load(const std::string& filename) {
...
void Image4unorm8::save(const std::string& filename) {
